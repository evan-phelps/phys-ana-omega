...
dfkin = pd.DataFrame.load('../testdata/recon_dfkin.p')
...
# branches = ['mcnpart', 'mcid', 'mcm', 'mcp', 'mctheta', 'mcphi']
branches = ['gpart', 'id', 'p', 'cx', 'cy', 'cz']
rootfiles = ['genev102.gsim.gpp.38121.ana.root', 'genev102.gsim.gpp.10.ana.root', 'trim.root']
# data set names corresponding to each of rootfiles
dfnames = ['run38121', 'run10', 'experiment']
# import tree data as 3 numpy structured records
treerecs = [root2rec('../testdata/%s' % fn, treename='h10', branches=branches, selection='id[0]==11 && id[1]==2212 && id[2]==211 && id[3]==-211') for fn in rootfiles]
...
dfkin.save('../testdata/recon_dfkin.p')
