...
public :
   ...
   Int_t           gpart;
   Short_t         id[23];   //[gpart]
   Char_t          stat[23];   //[gpart]
   UChar_t         dc[23];   //[gpart]
   UChar_t         cc[23];   //[gpart]
   UChar_t         sc[23];   //[gpart]
   UChar_t         ec[23];   //[gpart]
   UChar_t         lec[23];   //[gpart]
   Float_t         p[23];   //[gpart]
   Float_t         m[23];   //[gpart]
   Char_t          q[23];   //[gpart]
   Float_t         b[23];   //[gpart]
   ...
   Int_t           sc_part;
   UChar_t         sc_sect[23];   //[sc_part]
   UChar_t         sc_hit[23];   //[sc_part]
   UChar_t         sc_pd[23];   //[sc_part]
   UChar_t         sc_stat[23];   //[sc_part]
   Float_t         edep[23];   //[sc_part]
   Float_t         sc_t[23];   //[sc_part]
   Float_t         sc_r[23];   //[sc_part]
   Float_t         sc_c2[23];   //[sc_part]
   Int_t           cc_part;
