...
def usage():
    print(
        'skim_small.py [-f] [-w <workingdir>] [-c <parmsfilepath>] [-i <inputstring>] [-N <numtoproc>] [-t treepath] [-o outfile]')
...
def main(argv):
    ...
    handlers = [("h6thrown", r.DH_H6Maker_Thrown),
                ...
                ("eid_efid_hfid", r.DH_Hfid),
                ("mon_eid_efid_hfid", r.DH_Hists_Monitor),
