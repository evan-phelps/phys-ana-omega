...
def usage():
    print(
        'skim_loose.py [-f] [-w <workingdir>] [-c <parmsfilepath>] [-i <inputstring>] [-N <numtoproc>] [-t treepath] [-o outfile]')
...
def main(argv):
    ...
    handlers = [("mon_raw", r.DH_Hists_Monitor),
                ...
                ("eid_efid_w", r.DH_W_Skim),
                ("eid_efid_w_mmp", r.DH_MMp_Skim),
                ("mon_eid_efid_w_mmp", r.DH_Hists_Monitor),
                ("h10_eid_efid_w_mmp", r.DH_CloneH10)
               ]
