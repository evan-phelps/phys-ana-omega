...
class DH_H6Maker : public DataHandler
{
    public:
        ...
        DH_H6Maker(std::string name = "H6Maker", TDirectory *pDir = NULL, H10 *h10looper = NULL) : DataHandler(name, pDir, h10looper)
        {
            ...
            h_nphe = new TH1D("h_nphe", "nphe cut efficiency frequency", 100, 0, 1);
            h_tr_eff = new TH1D("h_tr_eff", "track reconstruction efficiency frequency", 200, 0, 2);
