...
public :
   ...
   Int_t           lac_part;
   Int_t           lec_sect[50];   //[lac_part]
   Int_t           lec_hit[50];   //[lac_part]
   Int_t           lec_stat[50];   //[lac_part]
   Float_t         lec_etot[50];   //[lac_part]
   Float_t         lec_t[50];   //[lac_part]
   Float_t         lec_r[50];   //[lac_part]
   Float_t         lec_x[50];   //[lac_part]
   Float_t         lec_y[50];   //[lac_part]
   Float_t         lec_z[50];   //[lac_part]
   Float_t         lec_c2[50];   //[lac_part]
   //MC banks
   Int_t           mcnentr;
   UChar_t         mcnpart;
